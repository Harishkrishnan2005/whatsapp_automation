      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-4 py-12">
        <div className="grid gap-8 lg:grid-cols-[360px_1fr]">
          <div className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-8 shadow-2xl backdrop-blur-xl">
            <p className="text-sm uppercase tracking-[0.35em] text-cyan-300/80">Staff & admin portal</p>
            <h1 className="mt-6 text-5xl font-bold text-white">WhatsApp Automation</h1>
            <p className="mt-4 text-sm leading-7 text-slate-300">Choose the right portal for your role and enjoy the new staff/admin interface with modern cards, clean navigation, and full UX consistency.</p>
